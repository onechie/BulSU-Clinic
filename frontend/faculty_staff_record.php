...
<head>
  ...
  <title>Faculty/Staff Records</title>
</head>
...
<body class="">
        ...
        <div class='bg-gray-100 h-full w-full py-3 px-6 flex flex-col min-h-[500px] min-w-[900px]'>
          ...
          <div class='w-full p-10 border border-gray-300 rounded-md flex flex-col flex-grow'>
            <div class='flex flex gap-[50px] pb-5'>
              <!-- Table info -->
              <div class='w-[50%]'>
                <h1 class='font-medium text-xl text-gray-700 pb-2'>Faculty/Staff Patients Record Overview</h1>
  ...
  <!-- SCRIPTS -->
  <script type='module' src="/src/js/pages/facultyStaffRecord.js"></script>
</body>
