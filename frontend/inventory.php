            ...
            <div class='flex gap-[50px]'>
              ...
              <div class="w-[50%] flex flex-col justify-between">
                ...
                <div class='flex gap-3 justify-end'>
                  <button class='rounded-md bg-blue-600 text-gray-200 px-3 py-2 hover:bg-blue-500' onclick="toggleModal('modal-id')">New medicine</button>
                  <button class='rounded-md bg-green-600 text-gray-200 px-3 py-2 hover:bg-green-500' type="button">Print</button>
                </div>
                <!-- Search -->
              ...
              <table class='min-w-full table-auto border-collapse'>
                ...
                <tbody id="tableBody" class="">
                  <tr class='border-b border-gray-200'>
                    ...
                    <td class='py-3 text-gray-500'>Biogesic</td>
                    <td class='py-3 text-gray-500'>Tablet</td>
                    <td class='py-3 text-gray-500'>01-01-2024</td>
                    <td class='py-3 text-gray-500'>2</td>
                    <td class='py-3 text-gray-500'>100</td>
                    <td class='py-3 text-gray-500'>200</td>
