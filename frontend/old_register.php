...
<body class='w-fit h-fit'>
  <div class='relative bg-gray-100 h-full pt-[45px] min-w-[440px]'>
    <?php
    //HEADER COMPONENT
    require_once './frontend/components/header.php';
    //require_once './frontend/components/notification.php'
    ?>
    <div class="flex items-center justify-center px-6 h-full min-h-[730px] min-w-[full] sm:min-h-[750px]">
      <div class="w-full rounded-md border bg-gray-800 border-gray-700 max-w-2xl">
        <div class="p-6 space-y-4 sm:space-y-6">
          ...
          <button type="button" id="registerButton" onclick="(submitUserData())" class="w-full text-gray-200 bg-green-700 hover:bg-green-600 font-medium rounded-md h-[40px] text-center disabled:bg-gray-700">
