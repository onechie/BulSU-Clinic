            ...
            <form class="p-6 space-y-4 sm:space-y-6 w-full rounded-md border bg-gray-800 border-gray-700 max-w-2xl my-auto" id='registerForm' novalidate>
                ...
                <div class='flex flex-col gap-2 sm:gap-3'>
                    <div class='flex justify-center items-center gap-4'>
                        <div id='profilePicturePreview' class='relative outline-none ring-2 ring-gray-500 hover:ring-gray-600 cursor-pointer rounded-full h-[100px] w-[100px] overflow-hidden bg-center bg-cover bg-[url=("")]'>
                            <div class="absolute hover:bg-gray-600/20 h-full w-full flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 text-gray-600" id='profileIcon'>
                        ...
                        <div class=''>
                            ...
                            <label for="profilePicture" class="text-gray-400 underline cursor-pointer hover:text-gray-500">
                                Upload image
                            </label>
                    ...
                    <div class='flex flex-col sm:flex-row gap-3 w-full'>
                        <div class="w-full sm:w-[50%]">
                            ...
                            <input type="text" name="username" class="outline-none ring-1 ring-gray-600 bg-gray-700 p-2.5 text-sm text-gray-400 rounded-md w-full hover:ring-gray-500 focus:ring-gray-500" placeholder="Username" required="">
                        </div>
                        <div class="w-full sm:w-[50%]">
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-400">Your email</label>
                            <input type="email" name="email" class="outline-none ring-1 ring-gray-600 bg-gray-700 p-2.5 text-sm text-gray-400 rounded-md w-full hover:ring-gray-500 focus:ring-gray-500" placeholder="Email" required="">
                        </div>
                    ...
                    <div class='flex gap-3 flex-col sm:flex-row w-full'>
                        <div class='w-full sm:w-[50%]'>
                            ...
                            <input type="password" name="password" placeholder="Password" class="outline-none ring-1 ring-gray-600 bg-gray-700 p-2.5 text-sm text-gray-400 rounded-md w-full hover:ring-gray-500 focus:ring-gray-500" required="">
                        </div>
                        <div class='w-full sm:w-[50%]'>
                            <label for="password" class="block mb-2 text-sm font-medium text-gray-400">Confirm Password</label>
                            <input type="password" name="confirmPassword" placeholder="Confirm Password" class="outline-none ring-1 ring-gray-600 bg-gray-700 p-2.5 text-sm text-gray-400 rounded-md w-full hover:ring-gray-500 focus:ring-gray-500" required="">
                        </div>
                    </div>

                    <div class='my-3'>
                        <input type="checkbox" name="agreement" class="w-4 h-4 accent-white ring-1 ring-gray-600 rounded-md">
                        <label class="ms-3 text-sm text-gray-400" for="agreement">I have read and agree to the Terms and Policies.</label>
                    </div>
                </div>
                <button type="submit" id="registerButton" class="w-full text-gray-200 bg-green-700 hover:bg-green-600 font-medium rounded-md h-[40px] text-center disabled:bg-gray-700">
